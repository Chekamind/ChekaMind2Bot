...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if context.user_data.get("awaiting_comment"):
        ...
        cursor.execute("INSERT INTO stats (user_id, username, comment, timestamp) VALUES (?, ?, ?, ?)",
